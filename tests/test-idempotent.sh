...
# Test that /path/#[expr] can create a node, and is idempotent
touch -r $0 $hosts

# Add a new ip+host to $hosts using #[expr]
augtool --nostdinc -r $root -I $abs_top_srcdir/lenses > /dev/null <<EOF
set /files/etc/hosts/#[ipaddr='192.0.2.0']/ipaddr 192.0.2.0
set /files/etc/hosts/#[ipaddr='192.0.2.0']/canonical dns1
save
EOF
